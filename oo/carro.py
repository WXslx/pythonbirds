...
class Direcao:
    rotacao_a_direita_dct = {NORTE : LESTE, LESTE : SUL, 
    SUL : OESTE, OESTE : NORTE}
    rotacao_a_esquerda_dct = {NORTE : OESTE, LESTE : NORTE,
    SUL : LESTE, OESTE : SUL}
    ...
    def girar_a_direita(self):
        self.valor = self.rotacao_a_direita_dct

    def girar_a_esquerda(self):
        self.valor = self.rotacao_a_esquerda_dct
